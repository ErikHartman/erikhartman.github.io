...
- [ ] A synonym for the outcome of most clinical importance
...
**Question 19**  
Which of the following is “a measure of change in one quantity (y) per unit of another quantity (x) on which y depends”  
- …index  
- …odds ratio  
- …proportion  
- **…incidence rate**
...
**Question 20**  
The difference between the odds ratio and the corresponding risk ratio gets larger…  
- …the more common the exposure is  
- …the less common the outcome is  
...
To meet health authorities’ need for a single measure of health benefits for systematic comparison to costs, health economists developed the QALY in the 1980’s and 1990’s. What is true about QALY? More than one statement can be correct. ✅
  ...
  - [x] The acronym stands for Quality Adjusted Life Year 
...
- [ ] AF increases when the exposure prevalence increases 
- [x] AF increases when RR increases 
...
- [ ] PAF decreases when RR increases 
- [x] PAF increases when the exposure prevalence increases 
...
- [ ] YLL increases the more common the disease is 
